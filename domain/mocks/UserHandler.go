...
func (_m *UserHandler) GetbyID() echo.HandlerFunc {
	ret := _m.Called()
...
func (_m *UserHandler) LoginGoogle() echo.HandlerFunc {
	ret := _m.Called()
...
// SignUpGoogle provides a mock function with given fields:
func (_m *UserHandler) SignUpGoogle() echo.HandlerFunc {
	ret := _m.Called()
